          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li>
                ...
                services (GitHub, GitLab, Slack, Google Calendar, Linear, Notion), we access
                activity data such as commits, messages, calendar events, issues, and page edits
